...
rev-alert-stage-massacre-start = Внимание всему персоналу! Мы обнаружили значительную ошибку в нашей системе распределения персонала. Среди экипажа станции были обнаружены враги корпорации, а именно: { $headRevsNames }. Комитет Государственной Безопасности инкриминирует данным сотрудникам статью 504 - Теракт. Разберитесь с ними согласно Правилам Внутреннего Распорядка и по возможности доставьте на станцию Генерального Штаба. Слава СССП!
...
# Революция
rev-alert-stage-massacre-end-with-rev-won = Революция на станции завершилась победой повстанцев. Экипажу рекомендуется соблюдать осторожность, пока станция не будет восстановлена под контролем НТ.
rev-objectives-progress = Прогресс целей революционеров: { $progress }